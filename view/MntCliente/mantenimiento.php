                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control" id="cli_ruc" name="cli_ruc" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control" id="cli_telf" name="cli_telf" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control" id="cli_correo" name="cli_correo" />
                            </div>
                        </div>
                    </div>
